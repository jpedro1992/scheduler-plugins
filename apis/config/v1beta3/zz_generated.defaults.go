...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&AppClassArgs{}, func(obj interface{}) { SetObjectDefaults_AppClassArgs(obj.(*AppClassArgs)) })
...
func SetObjectDefaults_AppClassArgs(in *AppClassArgs) {
	SetDefaults_AppClassArgs(in)
}
