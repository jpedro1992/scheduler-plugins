...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*AppClassArgs)(nil), (*config.AppClassArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_AppClassArgs_To_config_AppClassArgs(a.(*AppClassArgs), b.(*config.AppClassArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.AppClassArgs)(nil), (*AppClassArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_AppClassArgs_To_v1beta3_AppClassArgs(a.(*config.AppClassArgs), b.(*AppClassArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_AppClassArgs_To_config_AppClassArgs(in *AppClassArgs, out *config.AppClassArgs, s conversion.Scope) error {
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
	if err := v1.Convert_Pointer_string_To_string(&in.AppClassName, &out.AppClassName, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta3_AppClassArgs_To_config_AppClassArgs is an autogenerated conversion function.
func Convert_v1beta3_AppClassArgs_To_config_AppClassArgs(in *AppClassArgs, out *config.AppClassArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_AppClassArgs_To_config_AppClassArgs(in, out, s)
}

func autoConvert_config_AppClassArgs_To_v1beta3_AppClassArgs(in *config.AppClassArgs, out *AppClassArgs, s conversion.Scope) error {
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
	if err := v1.Convert_string_To_Pointer_string(&in.AppClassName, &out.AppClassName, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_AppClassArgs_To_v1beta3_AppClassArgs is an autogenerated conversion function.
func Convert_config_AppClassArgs_To_v1beta3_AppClassArgs(in *config.AppClassArgs, out *AppClassArgs, s conversion.Scope) error {
	return autoConvert_config_AppClassArgs_To_v1beta3_AppClassArgs(in, out, s)
}
