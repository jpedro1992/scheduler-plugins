...
func InitAppGroupInformer(kubeConfig *restclient.Config) (*schedlister.AppGroupLister, error) {
...
func InitNetworkTopologyInformer(kubeConfig *restclient.Config) (*schedlister.NetworkTopologyLister, error) {
