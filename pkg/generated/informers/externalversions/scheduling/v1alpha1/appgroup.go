	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SchedulingV1alpha1().AppGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SchedulingV1alpha1().AppGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&schedulingv1alpha1.AppGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *appGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schedulingv1alpha1.AppGroup{}, f.defaultInformer)
}
