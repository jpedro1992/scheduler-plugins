	...
	cases := []struct {
		...
		},
		{
			...
			desiredTopologyOrder: v1alpha1.TopologyList{
				...
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P11", Index: 11},
			},
		},
		{
			...
			desiredTopologyOrder: v1alpha1.TopologyList{
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P1", Index: 1},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P10", Index: 3},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P9", Index: 5},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P8", Index: 7},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P7", Index: 9},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P6", Index: 11},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P5", Index: 10},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P4", Index: 8},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P3", Index: 6},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P2", Index: 4},
				v1alpha1.AppGroupTopologyInfo{WorkloadName: "P11", Index: 2},
			},
		},
	}
