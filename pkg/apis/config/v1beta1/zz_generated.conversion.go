...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetworkMinCostArgs)(nil), (*config.NetworkMinCostArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NetworkMinCostArgs_To_config_NetworkMinCostArgs(a.(*NetworkMinCostArgs), b.(*config.NetworkMinCostArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetworkMinCostArgs)(nil), (*NetworkMinCostArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetworkMinCostArgs_To_v1beta1_NetworkMinCostArgs(a.(*config.NetworkMinCostArgs), b.(*NetworkMinCostArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*NodeNetworkCostFitArgs)(nil), (*config.NodeNetworkCostFitArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NodeNetworkCostFitArgs_To_config_NodeNetworkCostFitArgs(a.(*NodeNetworkCostFitArgs), b.(*config.NodeNetworkCostFitArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeNetworkCostFitArgs)(nil), (*NodeNetworkCostFitArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeNetworkCostFitArgs_To_v1beta1_NodeNetworkCostFitArgs(a.(*config.NodeNetworkCostFitArgs), b.(*NodeNetworkCostFitArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_NetworkMinCostArgs_To_config_NetworkMinCostArgs(in *NetworkMinCostArgs, out *config.NetworkMinCostArgs, s conversion.Scope) error {
...
// Convert_v1beta1_NetworkMinCostArgs_To_config_NetworkMinCostArgs is an autogenerated conversion function.
func Convert_v1beta1_NetworkMinCostArgs_To_config_NetworkMinCostArgs(in *NetworkMinCostArgs, out *config.NetworkMinCostArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_NetworkMinCostArgs_To_config_NetworkMinCostArgs(in, out, s)
}

func autoConvert_config_NetworkMinCostArgs_To_v1beta1_NetworkMinCostArgs(in *config.NetworkMinCostArgs, out *NetworkMinCostArgs, s conversion.Scope) error {
...
// Convert_config_NetworkMinCostArgs_To_v1beta1_NetworkMinCostArgs is an autogenerated conversion function.
func Convert_config_NetworkMinCostArgs_To_v1beta1_NetworkMinCostArgs(in *config.NetworkMinCostArgs, out *NetworkMinCostArgs, s conversion.Scope) error {
	return autoConvert_config_NetworkMinCostArgs_To_v1beta1_NetworkMinCostArgs(in, out, s)
}

func autoConvert_v1beta1_NodeNetworkCostFitArgs_To_config_NodeNetworkCostFitArgs(in *NodeNetworkCostFitArgs, out *config.NodeNetworkCostFitArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_string_To_string(&in.KubeConfigPath, &out.KubeConfigPath, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_string_To_string(&in.MasterOverride, &out.MasterOverride, s); err != nil {
...
// Convert_v1beta1_NodeNetworkCostFitArgs_To_config_NodeNetworkCostFitArgs is an autogenerated conversion function.
func Convert_v1beta1_NodeNetworkCostFitArgs_To_config_NodeNetworkCostFitArgs(in *NodeNetworkCostFitArgs, out *config.NodeNetworkCostFitArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_NodeNetworkCostFitArgs_To_config_NodeNetworkCostFitArgs(in, out, s)
}

func autoConvert_config_NodeNetworkCostFitArgs_To_v1beta1_NodeNetworkCostFitArgs(in *config.NodeNetworkCostFitArgs, out *NodeNetworkCostFitArgs, s conversion.Scope) error {
	if err := v1.Convert_string_To_Pointer_string(&in.KubeConfigPath, &out.KubeConfigPath, s); err != nil {
		return err
	}
	if err := v1.Convert_string_To_Pointer_string(&in.MasterOverride, &out.MasterOverride, s); err != nil {
...
// Convert_config_NodeNetworkCostFitArgs_To_v1beta1_NodeNetworkCostFitArgs is an autogenerated conversion function.
func Convert_config_NodeNetworkCostFitArgs_To_v1beta1_NodeNetworkCostFitArgs(in *config.NodeNetworkCostFitArgs, out *NodeNetworkCostFitArgs, s conversion.Scope) error {
	return autoConvert_config_NodeNetworkCostFitArgs_To_v1beta1_NodeNetworkCostFitArgs(in, out, s)
}
