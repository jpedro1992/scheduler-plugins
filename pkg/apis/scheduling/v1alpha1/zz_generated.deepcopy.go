...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppGroupWorkloadRefInfo) DeepCopyInto(out *AppGroupWorkloadRefInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppGroupWorkloadRefInfo.
func (in *AppGroupWorkloadRefInfo) DeepCopy() *AppGroupWorkloadRefInfo {
	if in == nil {
		return nil
	}
	out := new(AppGroupWorkloadRefInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TopologyInfo) DeepCopyInto(out *TopologyInfo) {
	*out = *in
	if in.OriginCosts != nil {
		in, out := &in.OriginCosts, &out.OriginCosts
		*out = make(OriginList, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
